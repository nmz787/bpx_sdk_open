...
void MotionLevelControl::setWalk() { impl_->selected_gait = MotionGait::Walk; }
void MotionLevelControl::setRunning() { impl_->selected_gait = MotionGait::Running; }
void MotionLevelControl::setLeftFlip() { impl_->selected_gait = MotionGait::Flip; }
void MotionLevelControl::setRightFlip() { impl_->selected_gait = MotionGait::Flip; }
void MotionLevelControl::setBipedal() { impl_->selected_gait = MotionGait::Bipedal; }
void MotionLevelControl::setInvBipedal() { impl_->selected_gait = MotionGait::Bipedal; }
void MotionLevelControl::setPronk() { impl_->selected_gait = MotionGait::WalkPhase; }
void MotionLevelControl::setPace() { impl_->selected_gait = MotionGait::WalkPhase; }
void MotionLevelControl::setBound() { impl_->selected_gait = MotionGait::WalkPhase; }
