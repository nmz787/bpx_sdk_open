...
if(NOT recovered_result EQUAL 0)
    message(FATAL_ERROR
        "Recovered probe failed with exit code ${recovered_result}\n${recovered_error}")
endif()
...
if(NOT precompiled_result EQUAL 0)
    message(FATAL_ERROR
        "Precompiled probe failed with exit code ${precompiled_result}\n${precompiled_error}")
endif()

if(NOT recovered_output STREQUAL precompiled_output)
    message(FATAL_ERROR
        "Recovered and precompiled probes diverged.\n"
        "--- recovered ---\n${recovered_output}\n"
        "--- precompiled ---\n${precompiled_output}\n")
endif()
