...
def import_bindings(install_root: Path):
    sys.path.insert(0, str(install_root))
    sys.modules.pop("bpx_sdk._bpx_sdk", None)
    sys.modules.pop("bpx_sdk", None)
    return importlib.import_module("bpx_sdk")
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="bpx-sdk-python-probe-") as temp_dir:
        ...
        os.chdir(temp_root)
        bpx_sdk = import_bindings(install_root)
